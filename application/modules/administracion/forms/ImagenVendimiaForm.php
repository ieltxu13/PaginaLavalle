...
class Administracion_Form_ImagenVendimiaForm extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $upload->setLabel('Elegir Imagen')
                ->setRequired()
                ->setDestination(APPLICATION_PATH . '/recursos/vendimia')
                ...
                ->addValidator('NotExists', false, 
                        array(APPLICATION_PATH . '\recursos\vendimia'));
