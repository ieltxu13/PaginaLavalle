...
class Administracion_Form_ImagenCandidataForm extends Twitter_Bootstrap_Form
{
    ...
    public function init()
    {
        ...
        $upload = $this->createElement('file', 'upload');
        $upload->setLabel('Elegir Imagen')
                ->setRequired()
                ->setDestination('img/candidatas')
                ->addValidator('Count', false, 1)//Asegura que sea solo un archivo
                ->addValidator('Size', false, 1024000000)//Limite al tamaño del archivo
                ->addValidator('Extension', false, 'jpg,png,gif')
                ->addValidator('NotExists', false, 
                        array(APPLICATION_PATH . '\..\public\img\candidatas'));
