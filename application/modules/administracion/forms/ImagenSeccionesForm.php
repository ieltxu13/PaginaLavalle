...
class Administracion_Form_ImagenSeccionesForm extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $upload->setLabel('Elegir Imagen')
                ->setRequired()
                ->setDestination(APPLICATION_PATH . '/recursos/secciones')
                ...
                ->addValidator('NotExists', false, 
                        array(APPLICATION_PATH . '\recursos\secciones'));
